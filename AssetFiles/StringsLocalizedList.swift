            ...
            for (nextKey, nextValue) in stringsDictionary {
                ...
                if swift {
                    ...
                    if hasTranslations {
                        ...
                        if devComment != nil {
                            implementation.append("        return NSLocalizedString(\"\(nextKeyString)\", tableName: \"\(fileName)\", comment: \"\(devComment!)\")\n")
                        } else {
                            implementation.append("        return NSLocalizedString(\"\(nextKeyString)\", tableName: \"\(fileName)\", comment: \"\(localizedString)\")\n")
                        }
                    } else {
                    ...
                    if hasTranslations {
                        ...
                        if devComment != nil {
                            implementation.append("    return NSLocalizedStringFromTable(@\"\(nextKeyString)\", @\"\(fileName)\", @\"\(devComment!)\");\n")
                        } else {
                            implementation.append("    return NSLocalizedStringFromTable(@\"\(nextKeyString)\", @\"\(fileName)\", nil);\n")
                        }
                    } else {
                        implementation.append("    return @\"\(localizedString)\";\n")
                    }
